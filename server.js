...
async function seedData() {
  try {
    ...
    await doctors.insertMany(listDoctors);

    // Insert corresponding availability records
    // For simplicity, all records are for "Monday". Doctors 1,2,3 are available;
    // Doctor 4 is considered "not available" (you can apply your own logic in your API to mark off-duty).
    const availabilities = [
      ...
      },
      {
        ...
        day_of_week: 'Monday',
        start_time: '12:00 PM',
        end_time: '2:00 PM', // Not available
      },
    ];
    await availableDoctors.insertMany(availabilities);
